...
The goal of this project was to create a React porfolio.

- My motivation was to create a new portfolio using React.
- I built this project to further my skills and proficiency in React.
- The main solution I strove for was to make a professional and visually appealing React portfolio.
- My main learning experience from this project was how to effectively create a React application and deploy it.
...
Node is required to install all packages and run the server and client.
